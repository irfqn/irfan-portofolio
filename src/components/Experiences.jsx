...
const experiences = [
  {
    ...
    description:
      "As the laboratory assistant of Software Engineering & Application laboratory, I am responsible on managing the practicum system and curicullum along with other assistant.",
  },
  {
...
const Experiences = () => {
  return (
    <section
      id="experiences"
      className="bg-black text-white py-15 max-sm:py-10"
    >
