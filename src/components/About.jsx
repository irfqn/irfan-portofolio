...
const DescAbout = () =>{
    return(
        <div>
            <p className="text-white my-8 pr-20 text-justify max-md:pr-0">A fresh graduate in Computer Engineering with a strong interest in web development. Experienced in frontend and backend development, with projects involving cloud technology deployment. Actively improving skills through independent projects and training.</p>
        ...
        <div className="flex max-md:flex-col gap-20">
            ...
            <div className="kanan w-full h-auto">
                ...
                <div className="flex my-16">
                    <img src={irfan} alt="foto_irfan" className="w-1/4 max-sm:w-[45%]"/>
                    <div className="px-5 flex flex-col justify-between max-sm:pl-5 max-sm:px-0">
                        <p className="font-semibold text-white max-sm:text-sm">Future-Ready Development</p>
                        <p className="text-lg font-normal leading-6 text-gray-300 max-sm:text-sm">Developing solutions that scale with tomorrows technology.</p>
                    </div>
                </div>
            </div>
        </div>
